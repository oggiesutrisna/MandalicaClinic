...
<!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-WHCF9JJ');</script>
    <!-- End Google Tag Manager -->
    <meta charset="utf-8">
    <meta content="width=device-width, initial-scale=1.0" name="viewport">

    <title>Mandalica Clinic</title>
    <meta content="Layanan kesehatan terbaik di Mandalika" name="description">
    <meta content="Bertempat di lokasi strategis Mandalika, Mandalica Clinic siap memberikan layanan kesehatan profesional untuk anda dan keluarga." name="keywords">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WHCF9JJ"
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                <h1>Layanan kesehatan terbaik di Mandalika</h1>
                <h2>Bertempat di lokasi strategis Mandalika, Mandalica Clinic siap memberikan layanan kesehatan profesional untuk anda dan keluarga.</h2>
                <div>
