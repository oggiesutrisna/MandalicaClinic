                    ...
                    <div
                        ...
                        <div class="card card-danger">
                            <div class="card-header">
                                <h4>QR Verification System | The Patient <b>{{ $pasien->nama }}</b> is verified.</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="nama" type="nama" class="form-control" name="nama" autofocus
                                            value="{{ $pasien->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="nama" type="nama" class="form-control" name="nama" autofocus
                                            value="{{ $pasien->dateappointment }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="nama" type="nama" class="form-control" name="nama" autofocus
                                            value="{{ $pasien->created_at }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="nama" type="nama" class="form-control" name="nama" autofocus
                                            value="{{ $pasien->jenisappointment }}" disabled>
                                    </div>
                                </div>
